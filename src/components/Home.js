        ...
        <div className="title">
            <div class="TitresDuJour">
                <div class="row">
                    ...
                    <div class="col-6 col-md-4"><img src={m3} alt="img" width={600}></img></div>
                </div>

                <div class="row">


                    <div class="col-12 col-md-8"><img src={m4} alt="img" width={600}></img></div>
                    <div class="col-6 col-md-4"><img src={m5} alt="img" width={600}></img></div>
                </div>
                <div class="row">
                    <div class="col">
                        <img src=".." alt="img"></img>
